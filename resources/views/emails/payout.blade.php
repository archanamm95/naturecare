<html lang="en"><head>
    ...
    <body>
        ...
        <td align="center" style="padding: 5px 15px 0px 15px;" class="section-padding">
            ...
            <tbody><tr><td align="left" valign="top" style="padding:10px;font:9px/15px Arial;text-align:justify;color:#a6a6a6">Payout request is accepted</td></tr>
        ...
        <table width="600" bgcolor="#f9f9f9" style="font-family: MyriadPro-Regular, 'Myriad Pro Regular', MyriadPro, 'Myriad Pro', Helvetica, Arial, sans-serif;">
            ...
            <tbody>
                ...
                <tr>
                    ...
                    <td style="padding:30px 30px 10px 30px"><h2 style="color:#000;">Amount{{$amount}}</h2></td>
...
The cloudmlmsoftware Coach
                ...
                <tr>
                    ...
                    <td style="padding:20px 30px">
                        ...
                        <b style="color:#000; font-size:16px;"> Please check your Balance </b><br>
