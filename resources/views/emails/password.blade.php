<html lang="en"><head>
    ...
    <body>
        ...
        <td align="center" style="padding: 5px 15px 0px 15px;" class="section-padding">
            ...
            <tbody><tr><td align="left" valign="top" style="padding:10px;font:9px/15px Arial;text-align:justify;color:#a6a6a6">You are receiving this mail as a registered member of {{$company_name}} Please add <a href="mailto:{{$email->from_email}}" style="text-decoration:underline;color:#a6a6a6" target="_blank">{{$email->from_email}}</a> to your address book to ensure delivery into your inbox.</td></tr>
        ...
        <table width="600" bgcolor="#f9f9f9" style="font-family: MyriadPro-Regular, 'Myriad Pro Regular', MyriadPro, 'Myriad Pro', Helvetica, Arial, sans-serif;">
            ...
            <thead>
                ...
                <tr>
                    ...
                    <td style="padding:22px 30px 18px 30px; border-bottom:2px solid #1e2064"><img src="{{ url('/files/images/icons/logo.png?v=2') }}" height="60" alt="{{$company_name}}"></td>
