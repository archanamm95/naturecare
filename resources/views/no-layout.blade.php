...
<head>
    ...
    <!-- Favicon /-->
    <link rel="shortcut icon" href="{{ url('img/cache/logo/'.$logo_icon_dark)}}" type="image/x-icon" /> <!-- Favicon /-->
    <!-- Facebook Metadata /-->
    ...
    <link rel="shortcut icon" href="{{url($logo_icon_dark)}}" />
...
<body class="font-sans @yield('page_class')  {{$theme_skin_class}}">
    @yield('content')
    @yield('overscripts')
