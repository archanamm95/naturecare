 <div class="card">
            ...
            <div class="card-footer">
                ...
                data-toggle="modal"
                data-target="#fsModal" style="font-size: 12px; width: 280px;margin-left: -21px;
">
