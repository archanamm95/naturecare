...
<div class = "card card bg-primary text-white">
    ...
    <div class="card-header header-elements-inline">
        ...
        <div class="card-header header-elements-inline-btn">
                ...
                <h3 class = "card-title">{{trans('viewTicket.all_tickets')}}</h3>
                ...
                <tr class="tableFont2">
                    ...
                    <td class="statuslabel ">  
                        ...
                        <select name="status" id ="ticketStatus" class="form-control update_status"  required>                                
                            ...
                            @foreach($status as $statuscarousel-item)

                                    <option status-id="{{$data->id}}" value="{{$statuscarousel-item->id}}"


                                    @if($data->statusid   ==  $statuscarousel-item->id) selected @endif>

                                    {{$statuscarousel-item->status}}</option>     
