...
<div class="form-group">
       ...
       <label class="col-md-2 col-form-label">Select Ticket</label>
...
<label class=" col-md-2 col-form-label" for="tags"> Tags </label> 
 ...
 <select data-placeholder="Choose Your Tags"  name="tags[]" id="ticket_tags" class=" col-sm-6 form-control chosen-select" multiple   data-parsley-mincheck="0" required  data-parsley-trigger="change" >
   ...
   @foreach($ticket as $tags_carousel-item)   
 ...
 {!! $errors->first('tags', '<label class="col-form-label required " for="tags">:message</label>')!!}
