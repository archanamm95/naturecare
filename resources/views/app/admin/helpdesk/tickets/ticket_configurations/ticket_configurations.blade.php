@extends('app.admin.layouts.default') {{-- Web site Title --}} @section('title') {{{ $title }}} :: @parent @stop @section('page_class', 'sidebar-xs') @section('styles') @parent @endsection @section('sidebar') @parent @include('app.admin.tickets.layout.sidebar') @endsection {{-- Content --}} @section('main')
<div class="row">
    <div class="col-sm-6">
        <div class="card card-flat  border-left-info border-right-info" id="ticket-categories">
            <div class="card-header header-elements-inline">
                <h4 class="card-title text-semibold color-green">{{trans('ticket_config.ticket_categories')}}<a class="header-elements-toggle"><i class="icon-more"></i></a></h4>
    ...
    <div class="col-sm-6">
              <div class="card card-flat  border-left-info border-right-info" id="ticket-tags">
            <div class="card-header header-elements-inline">
                <h4 class="card-title text-semibold color-green">{{trans('ticket_config.tags')}}<a class="header-elements-toggle"><i class="icon-more"></i></a></h4>
                <div class="header-elements">
                    <ul class="icons-list">
                        <li><a data-action="collapse"></a></li>
                    </ul>
            ...
            <div class="card-body">
                ...
                <form class="form-vertical categoryform" role="form" method="POST" action="{{ URL::to('admin/post_ticket_tags') }}">
                    <input type="hidden" name="_token" value="{{ csrf_token() }}" />
                    <div class="form-group">
                        <label class="col-form-label">{{trans('ticket_details.tag_name')}}</label>
...
<div class="row">
    <div class="col-sm-6">
        <div class="card card-flat  border-left-info border-right-info" id="ticket-statuses">
            <div class="card-header header-elements-inline">
                <h4 class="card-title text-semibold color-green">{{trans('ticket_config.status')}}<a class="header-elements-toggle"><i class="icon-more"></i></a></h4>
                <div class="header-elements">
                    <ul class="icons-list">
                        <li><a data-action="collapse"></a></li>
                    </ul>
            ...
            <div class="card-body">
                ...
                <form class="form-vertical statusform" role="form" method="POST" action="{{ URL::to('admin/post_ticket_status') }}">
                    <input type="hidden" name="_token" value="{{ csrf_token() }}" />
                    <div class="form-group">
                        <label class="col-form-label">{{trans('ticket_details.status_name')}}</label>
                    ...
                    <div class="form-group">
                        <label class="col-form-label">{{trans('ticket_details.icon')}}</label>
    ...
    <div class="col-sm-6">
              <div class="card card-flat  border-left-info border-right-info" id="ticket-priorities">
            <div class="card-header header-elements-inline">
                <h4 class="card-title text-semibold color-green">{{trans('ticket_config.priorities')}}<a class="header-elements-toggle"><i class="icon-more"></i></a></h4>
                <div class="header-elements">
                    <ul class="icons-list">
                        <li><a data-action="collapse"></a></li>
                    </ul>
            ...
            <div class="card-body">
                ...
                <form class="form-vertical priorityform" role="form" method="POST" action="{{ URL::to('admin/post_ticket_priority') }}">
                    <input type="hidden" name="_token" value="{{ csrf_token() }}" />
                    <div class="form-group">
                        <label class="col-form-label">{{trans('ticket_details.priority_key')}}</label>
