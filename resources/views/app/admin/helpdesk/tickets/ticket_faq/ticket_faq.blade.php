...
<!-- <div class="container">   -->
    ...
    <div class="card-header header-elements-inline">
        ...
        <div class="card-header header-elements-inline-btn">
                ...
                <h3 class = "card-title"> {{trans('ticket_details.ticket_faq')}} </h3>
...
<div id="faqs" class="tab-pane active">
  ...
  <form id="faq">        
    ...
    <div class="tab-content card card-default card-block">
...
<!-- Create New-->
  ...
  <div id="create" class="tab-pane fade">
    ...
    <form class="form" role="form" method="POST" action="{{ URL::to('admin/save_ticket_faq') }}" id="form1">
      ...
      <input type="hidden" name="_token" value="{{ csrf_token() }}">
        ...
        <div class="col-sm-12">
          ...
          <div class="form-group">
            ...
            <label class="col-md-2 col-form-label">{{trans('ticket_details.ticket_faq')}}</label>
