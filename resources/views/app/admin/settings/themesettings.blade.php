...
<div class="card card-flat" >
                        <div class="card-header header-elements-inline">
                            ...
                            <h4 class="card-title">{{ trans('settings.settings') }}</h4>
                        </div>
                        <div class="card-body"> 
                                ...
                                <fieldset>                                   
                                    <div class="form-group">
                                        <div class="row">
                                            ...
                                            <div class="col-sm-8">
                                                 <input type="form-check" name="theme" value="default" @if($theme == 'default')checked @endif> {{ trans('settings.default') }}
                                                 <br>
                                                 <br>
                                                 <input type="form-check" name="theme" value="dark" @if($theme == 'dark')checked @endif>{{ trans('settings.big_dark') }}
                                            </div>
                                        </div>
                                    </div>
 ...
 /*Dropzone.js Options - Upload an image via AJAX.*/
  Dropzone.options.myDropzone = {
    ...
    init: function() {
      ...
      this.on("card card-body", function(file, dataUrl) {
