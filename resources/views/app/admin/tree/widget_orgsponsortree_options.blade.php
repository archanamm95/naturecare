...
<a class="btn btn-default btnPrevious btn-md zoom-in" data-popup="tooltip" data-original-title="ZoomIn" data-placement="bottom" id="aZInSp" title="ZoomIn">
    <i aria-hidden="true" class="icon-zoomin3">
    </i>
</a>
<a class="btn btn-default btnPrevious btn-md reset" data-popup="tooltip" data-original-title="Reset" data-placement="bottom" id="btn-restart-sponsortreenode" title="Reset">
   <i aria-hidden="true" class="icon-reset">
    </i>
</a>
<a class="btn btn-default btnNext btn-md zoom-out" data-popup="tooltip" data-original-title="ZoomOut" data-placement="bottom" id="aZOutSp" title="ZoomOut">
