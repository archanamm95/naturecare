<!-- <a class="btn btn-default btn-md" data-popup="tooltip" data-original-title="Export PNG" data-placement="bottom" id="btn_save_scrht" title="Export PNG">
    <i aria-hidden="true" class="fa fa-picture-o">
    </i>
</a> -->
<a class="btn btn-default btnPrevious btn-md zoom-in" data-popup="tooltip" data-original-title="ZoomIn" data-placement="bottom" id="aZInInflncr" title="ZoomIn">
    <i aria-hidden="true" class="icon-zoomin3">
    </i>
</a>
<a class="btn btn-default btnPrevious btn-md reset" data-popup="tooltip" data-original-title="Reset" data-placement="bottom" id="btn-restart-influencertreenode" title="Reset">
   <i aria-hidden="true" class="icon-reset">
    </i>
</a>
<a class="btn btn-default btnNext btn-md zoom-out" data-popup="tooltip" data-original-title="ZoomOut" data-placement="bottom" id="aZOutInflncr" title="ZoomOut">
