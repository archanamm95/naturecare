        ...
        <div class="table-responsive">
                ...
                <thead class="headerfooter">
                    <tr>
                        ...
                        <th>Total Pv</th>  
                        @if($type == "Weekly")
                        <th>{{trans('dashboard.week')}} 1</th>  
                        <th>{{trans('dashboard.week')}} 2</th>  
                        <th>{{trans('dashboard.week')}} 3</th>  
                        <th>{{trans('dashboard.week')}} 4</th>  
                        @endif
                ...
                <tbody>
                    ...
                    <tr>
                        ...
                        @if($type == "Weekly")
                        <td>{{currency(round($report->week1))}}</td>  
                        <td>{{currency(round($report->week2))}}</td>  
                        <td>{{currency(round($report->week3))}}</td>  
                        <td>{{currency(round($report->week4))}}</td>  
                        @endif
                        <td>{{currency(round($report->total_income,2))}}</td>
                        <td>{{ucwords(str_replace('_', ' ', $report->purchase_type))}}</td>
                        <td>{{ date('d M Y H:i:s',strtotime($report->created_at))}}</td>
                    </tr>
                    @endforeach   
                </tbody>
                  <tfoot align = "left" class="headerfooter">
          <th></th><th></th><th></th><th></th><th></th> @if($type == "Weekly")<th></th><th></th><th></th><th></th>@endif<th>Total</th><th>{{currency(round($total_income))}}</th><th></th>
         </tfoot>
