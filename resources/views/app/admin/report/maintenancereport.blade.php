...
<div class="panel panel-flat" >
	...
	<div class="panel-heading">
        ...
        <h4 class="panel-title">{{trans('report.maintenance_report')}}</h4>
     ...
     <form action="{{URL::to('admin/maintenancereport')}}" method="post">
     	...
     	<div class="row">
     		...
     		<div class="form-group col-sm-6">
	     	  ...
	     	  <div class="form-group col-sm-6">
                ...
                <label class="form-label col-sm-3">{{trans('report.status')}}</label>

                <div class="col-sm-6">

                    <select  required name="bv"  class="form-control">
                        <option value='all'>{{trans('report.all')}}</option>
                        <option value='m'>{{trans('report.Maintain')}}</option>
                        <option  value='n'>{{trans('report.not_maintain')}}</option>
                    </select>
