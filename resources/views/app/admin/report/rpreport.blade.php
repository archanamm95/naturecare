...
<div class="card card-flat timeline-content">
                    <div class="card-header header-elements-inline">
                        <h4 class="card-title">{{trans('report.register_point_report')}}</h4>
     ...
     <form action="{{URL::to('admin/rpreport')}}" method="post">
         ...
         <div class="row">
            ...
            {{trans('ewallet.username')}} <span class="symbol required"></span>
             ...
             <label class="col-sm-3 control-label" for="username">
            {{trans('ewallet.track_id')}}<span class="symbol required"></span>
            </label>
                <div class="col-sm-6">
                     <input class="form-control " id="track_id" name="track_id" type="text" placeholder="{{trans('ewallet.track_id')}}" >
