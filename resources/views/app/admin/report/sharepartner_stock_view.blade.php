...
<div class="card card-flat timeline-content">
    ...
    <div id="invoice-content">
        ...
        <div class="table-responsive">
                 <table class="table table-invoice" id = "sharepartnerstockreport">
                <thead class="headerfooter">
                    <tr>
                        ...
                        <th>{{trans('products.in')}}</th>
                        <th>{{trans('products.out')}}</th>
                        <th>{{trans('products.balance')}}</th>
             ...
             <td>
                @foreach($item['in'] as $count)
                    {{$count}}<br>
                @endforeach
            </td>
             <td>
                @foreach($item['out'] as $price)
                   {{$price}}<br>
                @endforeach
            </td>
            <td>
                @foreach($item['balance'] as $price)
                   {{$price}}<br>
                @endforeach
            </td>
...
<script>
    $(document).ready(function() {
        $('#sharepartnerstockreport').DataTable( {
