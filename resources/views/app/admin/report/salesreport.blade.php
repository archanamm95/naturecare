...
<div class="card card-flat timeline-content">
                    <div class="card-header header-elements-inline">
                        <h4 class="card-title">{{trans('report.sales_report')}}</h4>
     ...
     <form action="{{URL::to('admin/salesreport')}}" method="post">
...
<!-- 
	     			   <span class="input-group-prepend ">
                                            <span class="input-group-addon daterange-single"><i class="icon-calendar22 daterange-single"></i></span>
                                        </span> -->
         ...
         <div class="row">
            ...
            {{trans('report.seller_name')}}<span class="symbol required"></span>
            </label>
                <div class="col-sm-6">
             ...
             <label class="col-sm-3 control-label" for="username">
            {{trans('report.purchased_username')}}<span class="symbol required"></span>
            </label>
                <div class="col-sm-6">
                     <input class="form-control " id="name" name="name" type="text" placeholder="{{trans('ewallet.username')}}" >
