                    ...
                    <!-- begin card -->
                     <div class="card card-flat">
                          <div class="card-heading">
                            <h5 class="card-title">{{trans('registration.create_new_admin')}}</h5>
                                        ...
                                        <fieldset>
                                            ...
                                            <!-- end row -->
                                             ...
                                             <div class="row">
                                                ...
                                                <div class="col-md-4">
                                                 ...
                                                 <div class="col-md-4">
                                                    <div class="form-group">
                                                        ...
                                                        <div class="controls">
                                                            <input type="text" name="username" id="username" placeholder="{{trans('register.username') }}" class="form-control" value="{{old('username')}}" data-parsley-group="wizard-step-1"  required />
                                                ...
                                                <div class="col-md-4">
                                                    <div class="form-group">
                                                        <label>{{trans('wallet.user_type') }}   <span>*</span> </label>
                                                        <div class="controls">
                                                           <select name="user_type" class="form-control">
                                                               <option value="accountant_admin" selected="true">Accountant Admin</option>
                                                               <option value="basic_staff_admin">Basic Staff Admin</option>
                                                           </select>
                                                        </div>
                                                    </div>
                                                </div>                                                
