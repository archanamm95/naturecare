                    ...
                    <!-- begin card -->
                     <div class="card card-flat">
                          <div class="card-heading">
                            <h5 class="card-title">{{trans('register.register_new_influencer')}}</h5>
                        ...
                        <div class="card-body">
                   <form action="{{url('admin/register')}}" method="POST" data-parsley-validate="true" name="form-wizard">
                                        ...
                                        <fieldset>
                                            ...
                                            <!-- end row -->
                                             <div class="row">
                                               ...
                                               <div class="col-md-6">
                                                    <div class="form-group">
                                                      <label> {{trans('register.lastname') }} <span>*</span> </label>
                                                        <div class="controls">
                                                            <input type="text" name="lastname" id="lastname" placeholder="{{trans('register.lastname') }}" class="form-control" value="{{old('lastname')}}" data-parsley-group="wizard-step-1"  required />
                                            ...
                                            <div class="row">
                                               ...
                                               <div class="col-md-6">
                                                    <div class="form-group">
                                                        ...
                                                        <div class="controls">
                                                            <input type="password" name="password_confirmation" placeholder="{{trans('register.confirm_password') }}" class="form-control"  data-parsley-group="wizard-step-3" data-parsley-minlength="6" data-parsley-equalto="#password" required />
                                                        </div>
                                                    </div>
                                                </div>                                               
                                            </div>
