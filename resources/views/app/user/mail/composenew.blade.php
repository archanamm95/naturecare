...
<div id="email-page">
                        ...
                        <!-- Single mail -->
                            <div class="panel panel-white" id="single-compose" style="display: none;">
                                <form class="mailcomposeform"   method="POST" name="parsley-mail">
                                <!-- Mail toolbar -->
                                    ...
                                    <div class="navbar navbar-default">
                                        ...
                                        <div class="navbar-collapse collapse" id="inbox-toolbar-toggle-single">
                                            <div class="btn-group navbar-btn">
                                                <button type="submit" class="submitmail btn bg-blue"><i class="icon-checkmark3 position-left"></i> Send mail</button>
                                            </div>

                                            <div class="btn-group navbar-btn">

                                                <button type="button" class="btn btn-default button-email-compose-cancel"><i class="icon-cross2"></i> <span class="hidden-xs position-right">Cancel</span></button>
                ...
                <div class="navbar-right">
                    <p class="navbar-text">
                        <span class="text-semibold">
                           Page {{$all_mail->currentPage()}}
                        </span>
                        with
                        <span class="text-semibold">
                            {{$all_mail->perPage()}} items
                        </span>
                    </p>
        ...
        <div class="navbar navbar-default">
            ...
            <div class="navbar-collapse collapse" id="inbox-toolbar-toggle-single">
                ...
                <div class="navbar-right">
                    <p class="navbar-text">
                        <span class="text-semibold">
                           Page {{$all_out_mail->currentPage()}}
                        </span>
                        with
                        <span class="text-semibold">
                            {{$all_out_mail->perPage()}} items
                        </span>
                    </p>
                    <div class="btn-group navbar-left navbar-btn">
