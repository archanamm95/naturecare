        ...
        <div class="card">
            ...
            <div class="card-body no-padding">
                <ul class="nav nav-sidebar" data-nav-type="accordion" id="myTab">
                    ...
                    <li class="nav-item">
                        <a class="nav-link active" href="#" id="showInBox" data-toggle="tab">
...
<div id="email-page">
    <div class="card card-white" id="single-compose" style="display: none;">
        <form action="{{url('user/register')}}" class="mailcomposeform" method="POST" name="parsley-mail">
            <!-- Mail toolbar -->
                ...
                <table class="table">
                    <tbody>
                        <tr>
                            ...
                            <td class="no-padding">
                                <input class="tagsinput-typeahead form-control autocompleteusersforemail" data-parsley-required-message="{{trans('all.at_least_one_reciepient_required')}}" data-role="tagsinput" id="to" name="to" placeholder=" {{trans('mail.add_recipient')}}" required="required" type="text"/>
                            </td>
                        </tr>
                        <tr>
                            <td>
                            ...
                            <td class="no-padding"><input type="text" name="subject" class="form-control" required="required" placeholder=" {{trans('mail.add_subject')}}" data-parsley-required-message = "{{trans("all.specify_email_subject")}}"></td>
...
$(document).ready(function(){
 ...
 {
  $.ajax({
   url: CLOUDMLMSOFTWARE.siteUrl+"/user/pagination/fetch_data?page="+page,
   dataType: 'json',
   async: true,
   type: 'get',
   success:function(data){
