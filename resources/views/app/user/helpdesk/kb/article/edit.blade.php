                ...
                <div class="card-footer"  >
                    <div class="col-md-12">  
                       <div class="row">
                        ...
                        <a href="{{url('user/helpdesk/kb/article/show/'.$article->slug)}}" target="_blank" class="btn btn-primary">{{Lang::get('lang.show')}}</a>

                        <span class="btn btn-danger btn-info btn-xs btn-delete-kb-article2" data-id="{{$article->slug}}" style="margin-top: 10px; "> {{Lang::get('lang.delete')}} </span>&nbsp;
...
<div class="modal" id="j">
                        <div class="modal-dialog">
                            <div class="modal-content">
                                {!! Form::open(['method'=>'post','action'=>'user\Helpdesk\kb\Knowledgebase@store']) !!}
