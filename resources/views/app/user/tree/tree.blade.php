@extends('app.user.layouts.default') {{-- Web site Title --}} @section('title') {{{ $title }}} ::
@parent @stop @section('meta_keywords')@parent 
    ...
    <div class="card-body">
        <div class="row text-center">
            <div class="tree-guide-bar col-sm-12">
                <div class="badge  bar bar-member ">{{trans('tree.member')}}</div>
                <div class="badge  bar bar-dealer ">{{trans('tree.dealer')}}</div>
                <div class="badge  bar bar-sharepartner ">Share Partner</div>
            </div>
        </div>
        <div class="overflow">
