...
<div class="alert alert-primary bg-white alert-styled-left alert-dismissible">
                        ...
                        <div class="text-center py-2">
                            ...
                            <span class="text-muted d-block">  {{trans('dashboard.we_can_customize_this_counter_for_your_dashboard_for_daily')}}, {{trans('dashboard.weekly')}}, {{trans('dashboard.or_specific_hours_bonuses_and_awards')}}. {{trans('dashboard.isnt_it_nice')}}?  </span>
                        </div>
                    </div>
