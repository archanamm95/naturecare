...
<div class="panel panel-success" >
	...
	<div class="panel-heading">
     ...
     <form action="{{URL::to('user/transactionreport')}}" method="post">
     	...
     	<div class="row">
	     	...
	     	<div class="form-group col-sm-6">
	     		...
	     		<label class="form-label col-sm-3">Pick end date</label>
        ...
        <div class="row">
            ...
            <div class="form-group col-sm-6">
                ...
                <label class="form-label col-sm-3">Position</label>
                ...
                <div class="col-sm-6">
                    ...
                    <select class="form-control" name="position" id="position" required="true">
                            ...
                            <option value="{{$package_item->id }}">{{$package_item->package}}</option>
