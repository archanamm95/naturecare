...
<div id="ct">
  <div class="container">
   <img src="{{ url('uploads/documents/'.$post->thumnail) }}"  class="card-image img-fluid" alt="product"/><a href="{{url('user/download-image/'.$post->thumnail)}}" class="btn" type="button" ><i class="fa fa-download"></i></a>
 </div>
  <div class="mt-4">
   <a href="{{url('user/download/'.$post->name)}}" class="btn btn-dark" type="button" ><i class="fa fa-download"></i></a>
   <a href="{{url('user/get-document/'.$post->name)}}" class="btn btn-dark" type="button" target="_blank" ><i class="fa fa-eye"></i></a>
 </div>
   <br>
  ...
  <span class="header"> {{$post->file_title}}</span>
  <blockquote class="p-sty">
    <p ><i>{!!$post->sub_text!!} </i></p>
  </blockquote>
  <blockquote class="p-sty1">
