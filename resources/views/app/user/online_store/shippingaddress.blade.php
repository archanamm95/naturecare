    ...
    <div class="card-body">
        ...
        <form class="form-vertical steps-validation" action="{{url('user/purchase-shop')}}" method="POST" data-parsley-validate="true" name="form-wizard" id="regform" enctype="multipart/form-data">
            ...
            <fieldset>
                ...
                <div class="row">
                    <div class="col-md-6">
                        <div class="required form-group {{ $errors->has('billing_firstname') ? ' has-error' : '' }}">
                            {!! Form::label('name', trans("register.first_name"), array('class' => 'col-form-label')) !!} {!! Form::text('billing_firstname', $BillingAddress->fname, ['class' => 'form-control' ,'id'=>'fname','required' => 'required','data-parsley-required-message' => trans("all.please_enter_first_name"),'data-parsley-group' => 'block-1']) !!}
                ...
                <br>
                <input type="checkbox" id="shipping" name="shipping" value="yes" onclick="hide_ship()" >
...
$('.steps-validation').click(function(e){
        ...
        var currentindex = $('.steps-validation .current');
         ...
         if(currentindex[2].id == 'regform-p-1'){
