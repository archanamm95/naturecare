...
<div class="row">
    <div class="col-lg-5 offset-lg-4">
      ...
      <div class="text-center mb-3">
                ...
                <h5 class="mb-0">{{trans('all.store_bitaps_payment')}}</h5>
...
@parent
 ...
 <script type="text/javascript">
     setInterval(function(){
            $.get("{{url('user/store-bitaps-status/'.$trans_id)}}", function( data ) { 
                 if(data['status'] == 'finish'){
                  console.log(2);
                        window.location.href = '/user/orderconfirm/'+data['id']+'/'+'bitaps';
                 }
