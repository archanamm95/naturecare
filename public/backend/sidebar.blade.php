...
@else
                  ...
                  <!--   <li class="has-sub {{set_active('admin/genealogy')}}{{set_active('admin/sponsortree')}}{{set_active('admin/tree')}}">
                        <a href="javascript:;">
                         ...
                         <ul class="sub-menu">
                            ...
                            <li class="{{set_active('admin/sponsortree')}}"><a href="{{url('admin/sponsortree')}}">Affiliate Program</a></li>
                           
                           
                        </ul>
                    </li> -->
                    
                     <li class="{{set_active('admin/sponsortree')}}">
                            <a href="{{url('admin/sponsortree')}}">
                                <i class="icon-tree7"></i>
                     ...
                     <li class="{{set_active('admin/register')}}">
                         ...
                         <li class="has-sub {{set_active('admin/postcreation')}}{{set_active('admin/viewpost')}}">
                        <a href="javascript:;">
                         ...
                         <ul class="sub-menu">
                            ...
                            <li class="{{set_active('admin/postcreation')}}"><a href="{{url('admin/postcreation')}}">Create</a></li>
                            <li class="{{set_active('admin/viewpost')}}"><a href="{{url('admin/viewpost')}}">View</a></li>
                   ...
                   <li class="has-sub {{set_active('admin/inbox')}}">
                    ...
                    <li class="has-sub {{set_active('admin/lead')}} {{set_active('admin/lead')}}">
                        <a href="{{url('admin/lead')}}">
                            <span class="badge pull-right"></span>
                            <i class="icon-ticket"></i> 
                            <span>{{trans('menu.lead')}}</span>
                        </a>
                       
                    </li> 

                    <li class="navigation-header"><span>{{trans('menu.affiliate_approve')}}</span> <i class="icon-menu" title="Settings"></i></li>

                     <li class="has-sub  {{set_active('admin/upload_doc')}} 
                     {{set_active('admin/approve_doc')}}">
                        <a  href="javascript:;" >
                           
                            <i class="icon-cogs"></i>
                            <span class="text">{{trans('menu.affiliate_approve')}}</span>
                        </a>
                        <ul class="sub-menu">
                             <li class="{{set_active('admin/upload_doc')}}"><a href="{{url('admin/upload_doc')}}">{{trans('menu.upload_documents')}}</a></li>
                             <li class="{{set_active('admin/approve_doc')}}"><a href="{{url('admin/approve_doc')}}">{{trans('menu.approve_documents')}}</a></li>
                        </ul>
                    </li>  
 ...
 -->
                           ...
                           <!--   <li class="{{set_active('admin/settings')}}"><a href="{{url('admin/settings')}}"> {{trans('menu.Commission_Settings')}}  </a></li> -->
                            ...
                            <!--  <li class="{{set_active('admin/plansettings')}}"><a href="{{url('admin/plansettings')}}">  {{trans('menu.plan-settings')}} </a></li> -->
                             ...
                             <li class="{{set_active('admin/bonus')}}"><a href="{{url('admin/bonus')}}">
                                {{trans('menu.affiliates_settings')}}  </a></li>
   ...
   -->
                    ...
                    {{set_active('admin/payoutreport')}}{{set_active('admin/joiningreportbysponsor')}}{{set_active('admin/joiningreportbycountry')}}{{set_active('admin/fundcredit')}}{{set_active('admin/topenrollerreport')}}">
                        <a  href="javascript:;" >
                            <!--<b class="caret pull-right"></b>-->
