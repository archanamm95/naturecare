...
class ProfileInfo extends Model
{
     ...
     * @var array
     */
    protected $fillable = ['user_id','dateofbirth','address1','address2','gender','city','location','occupation','country','state','zip','image','mobile','passport','skype','twitter','facebook','gplus','linkedin','whatsapp','wechat','about','package','currency','mnthly_cashback','account_number','account_holder_name','swift','sort_code','bank_code','paypal','profile','cover','btc_wallet','branch_address','id_file','id_file_back'];
