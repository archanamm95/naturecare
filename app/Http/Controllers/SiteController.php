...
class SiteController extends Controller
{
    ...
    public function index()
    {
        ...
        // return ('landing_page' == option('app.system_redirect') ?   "view('site-demo-v2.pages.home')" :  redirect('user/dashboard') );
    ...
    public function subscribe(SubscriberRequest $request)
    {
        ...
        Mail::send(
            'site.emails.demorequest',
            ['email' => $request->email,'ip_address' => $request->ip_address],
