...
class ImageController extends CloudMLMController
{
    ...
    public function postpackageUpload(Request $request)
    {
        $data = $request->all();
        $response = $this->file->upload($data);
        return $response;
    }
    public function postproductUpload(Request $request)
    {
        $data = $request->all();
        $response = $this->file->upload($data);
        return $response;
    ...
    public function postlogoUpload(Request $request)
    {
        $data = $request->all();
        $response = $this->file->upload($data);
        return $response;
    ...
    public function postlogoiconUpload(Request $request)
    {
        $data = $request->all();
        //dd($data);
        $response = $this->file->upload($data);
