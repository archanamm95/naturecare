...
use App\Http\Requests\Helpdesk\Ticket\TicketsTypeRequest;
use Datatables;
use Illuminate\Http\Request;
use Validator;
use Session;

class TicketsTypeController extends AdminController
{
    /**
    ...
    public function destroy($id)
    {
        ...
        $ticket_type->delete();
        Session::flash('flash_notification', array('level' => 'success', 'message' => 'Ticket type deleted successfully'));
        return redirect()->back();
    }
