...
use App\Http\Requests\Helpdesk\Ticket\TicketCannedResponseRequest;
use Datatables;
...
class TicketsCannedResponseController extends AdminController
{
    /**
    ...
    public function index()
    {
        ...
        return view('app.admin.helpdesk.tickets.canned_response.index', compact('title', 'sub_title', 'base', 'method'));
    }
    ...
    public function destroy($id)
    {
        ...
        Session::flash('flash_notification', array('level' => 'success', 'message' => 'Canned response deleted successfully'));
        return redirect()->back();
    }
