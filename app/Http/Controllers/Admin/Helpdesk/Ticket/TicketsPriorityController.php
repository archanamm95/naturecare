...
use App\Http\Requests\Helpdesk\Ticket\TicketsPriorityRequest;
use Datatables;
use Illuminate\Http\Request;
use Validator;
use Session;

class TicketsPriorityController extends AdminController
{
    /**
    ...
    public function destroy($id)
    {
        ...
        Session::flash('flash_notification', array('level' => 'success', 'message' => 'Priority deleted successfully'));
        return redirect()->back();
    }
