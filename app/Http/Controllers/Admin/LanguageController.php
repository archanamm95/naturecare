...
class LanguageController extends AdminController
{
    ...
    {
        return view('app.admin.language.index');
    }
    ...
    {
        // Show the page
        return view('app.admin/language/create_edit');
    }
    ...
    public function getEdit($id)
    {
        ...
        return view('app.admin/language/create_edit', compact('language'));
    }
    ...
    public function getDelete($id)
    {
        $language = $id;
        // Show the page
        return view('app.admin/language/delete', compact('language'));
    }
    ...
    public function data()
    {
        ...
        /*
        $video_category = Language::whereNull('languages.deleted_at')
        ...
        -> editColumn('icon', '{{ ($icon!="")? "<span class=\"flag $icon\" alt=\"flag\">&nbsp</span>":"" }}')
...
//            ->editColumn('icon', '{{ ($icon!="")? "<img style=\"max-width: 30px; max-height: 30px;\" src=\"../images/language/$id/$icon\">":""; }}')
            ->editColumn('icon', '{!! ($icon!="")? "<span class=\"flag $icon\" alt=\"flag\">&nbsp</span>":"" !!}')
