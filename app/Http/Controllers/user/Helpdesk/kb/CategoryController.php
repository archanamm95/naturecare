<?php namespace App\Http\Controllers\user\Helpdesk\kb;
 ...
 */
class CategoryController extends UserAdminController
{
    ...
    public function destroy($id, Category $category, Relationship $relation)
    {
        ...
        if ($relation != null) {
            ...
            try {
                $category->delete();
                Session::flash('flash_notification', array('level' => 'success', 'message' => trans('kb.category_deleted_successfully')));
