...
class LeadviewController extends UserAdminController
{
    ...
    public function leadview()
    {
        ...
        $data = LeadCapture::where('lead_capture.username', Auth::user()->username)->paginate(10);
    ...
    public function deletelead(Request $request)
    {
        ...
        Session::flash('flash_notification', array('level' => 'success', 'message' => trans('lead.lead_details_deleted_successfully')));
